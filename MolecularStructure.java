...
public class MolecularStructure {
    ...
    public boolean equals(Object obj) {
        ...
        if(this.molecules.size() != ((MolecularStructure) obj).getMolecules().size())
        {
            return false;
        }
        ...
        {
            int counter = 0;
            for(int j = 0 ; j < ((MolecularStructure) obj).getMolecules().size(); j++)
            {
                if(molecules.get(i).equals(((MolecularStructure) obj).getMolecules().get(j)))
                {
                    counter++;
                    break;
                }
